...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x3454E652Bd19ebA7447eDE7bD089EA48eCBfF33A;
...
contract NoorFinance is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x0891329C40A22FAAeC349f52d816C4600168D5D9;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 0x3454E652Bd19ebA7447eDE7bD089EA48eCBfF33A * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Noor Finance";
    string private _symbol = "NOOR";
